...
* 如果你喜欢我的这个博客模板，请在`dgynfi.github.io`这个repository点个赞——右上角**star**一下。
...
```
# Site settings
title: Dgynfi Blog          # 你的博客网站标题
SEOTitle: Dgynfi Blog	    # 在后面会详细谈到
description: "Cool Blog"    # 随便说点，描述一下

# SNS settings      
github_username: dgynfi     # 你的github账号
weibo_username: MF_梦飞6     # 你的微博账号，底部链接会自动更新的。
...
我的博客标题是 **“MengFei Blog”** 但是我想要在搜索的时候显示 **“梦飞的博客 | MengFei Blog”** ，这个就需要SEO Title来定义了。
