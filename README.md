...
![](http://dgynfi.github.io/img/dgynfi-blog.png)
...
SEOTitle: 梦飞的博客 | Dgynfi Blog  # 在后面会详细谈到
description: "Dgynfi Blog"        # 随便说点，描述一下
...
我的博客标题是 **“Dgynfi Blog”** 但是我想要在搜索的时候显示 **“梦飞的博客 | Dgynfi Blog”** ，这个就需要SEO Title来定义了。
