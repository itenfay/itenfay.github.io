...
### [View Live Dgynfi Blog &rarr;](http://dgynfi.github.io)  
...
-----------
 ...
 - ![cn](https://raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/China.png) **Chinese (Simplified)**: 感谢 [@BrucZhaoR](https://github.com/BruceZhaoR) 的 [中文翻译 &rarr;](https://github.com/dgynfi/dgynfi.github.io/blob/master/README.md)
...
- Brand new [Archive](https://dgynfi.github.io/archive/) page! It combines previous Archive and Tag page and it's backward-cmpatible.
...
```yml
# Site settings
title: Dgynfi Blog          # title of your website
SEOTitle: Dgynfi Blog       # check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: dgynfi     # modify this account to yours
weibo_username: MF_梦飞6     # the footer woule be auto-updated.
...
![](http://dgynfi.github.io/img/blog-sidebar.jpg)
...
![](http://dgynfi.github.io/img/blog-keynote.jpg)
...
It's possible that you want the two things different. For me, my site-title is **“MengFei Blog”** but I want the title shows in search engine is **“梦飞的博客 | MengFei Blog”** which is multi-language.
