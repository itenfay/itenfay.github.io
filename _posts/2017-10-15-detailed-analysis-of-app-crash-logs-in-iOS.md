...
![crash_flow.png](https://itenfay.github.io/images/crashreport/crash_flow.png)
...
![symbolicatecrash.png](https://itenfay.github.io/images/crashreport/symbolicatecrash.png)
...
![cr.png](https://itenfay.github.io/images/crashreport/cr_required_files.png)
...
![vim_bash_profile.png](https://itenfay.github.io/images/crashreport/vim_bash_profile.png)

添加`export DEVELOPER_DIR="/Applications/XCode.app/Contents/Developer"`，如下图所示，退出并保存。

![export_developer_dir.png](https://itenfay.github.io/images/crashreport/export_developer_dir.png)
...
等命令执行完成之后，我们可以在刚才的文件夹下面发现 vcrashLog.txt 符号化后的闪退日志。
 ...
 1、[DYFStore](https://link.jianshu.com?t=https://github.com/itenfay/DYFStore)-114939.crash -- 闪退日志
 2、DYFStore.app.dSYM -- dSYM 文件
 3、vcrashLog.txt -- 符号化后的日志

我们可以在已经符号化后的闪退日志里面看到我们代码出错的地方。(可以直接定位到闪退发生在哪个文件的哪一行代码)

![vcrashLog.png](https://itenfay.github.io/images/crashreport/vcrashLog.png)
