...
# git global setup
git config --global user.name "xiaoming" #用于提交的时显示名字
git config --global user.email "xiaoming@163.com" #用于提交的时显示邮箱地址
...
git clone https://github.com/dgynfi/DYFToast.git Toast #从远程库中克隆到指定的目录 (Toast)
...
git checkout –b dev #创建新分支并立即切换到该分支下
...
- [《 Git 教程 | 菜鸟教程 》](https://link.jianshu.com?t=https://www.runoob.com/git/git-tutorial.html)
- [《 入门教程 | Git基础 》](https://link.jianshu.com?t=https://git-scm.com/book/zh/v1/Git-基础)
- [《 Git教程 | 易百教程  》](https://link.jianshu.com?t=https://www.yiibai.com/git)
